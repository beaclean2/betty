...
<center>
 ...
 <h4><i class="icon icon-money icon-large"></i> Cash</h4></center><hr>
...
<?php
$payment_type = isset($_GET['pt']) ? $_GET['pt'] : ''; // Safe check for 'pt'

if ($payment_type == 'credit') {
    echo 'Due Date: <input type="date" name="due" placeholder="Due Date" style="width: 268px; height:30px; margin-bottom: 15px;" /><br>';
}

if ($payment_type == 'cash') {
    echo '<input type="number" name="cash" placeholder="Cash" style="width: 268px; height:30px; margin-bottom: 15px;" required/><br>';
}
?>
